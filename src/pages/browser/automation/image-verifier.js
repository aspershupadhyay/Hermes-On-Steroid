...
exports.verifyImageBuffer = verifyImageBuffer;
 ...
 */
function verifyImageBuffer(buf) {
    // Gate 1: file size
    ...
    try {
        sharpness = laplacianVariance(electron_1.nativeImage.createFromBuffer(buf), width, height);
    }
    catch {
...
function laplacianVariance(img, width, height) {
