      ...
      <div className="space-y-3">
        <div>
          ...
          <div className="flex items-center gap-2">
            <ColorPicker value={stroke || '#0BDA76'} onChange={v => onUpdate('stroke', v)} compact />
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <ColorPicker value={fill && fill !== 'transparent' ? fill : '#000000'} onChange={v => onUpdate('fill', v)} compact />
