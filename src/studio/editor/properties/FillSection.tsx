      ...
      {fillMode === 'solid' && (
        <>
          ...
          <div className="flex items-center gap-2 mb-2">
            <ColorPicker value={dispFill || '#EAEAEA'} onChange={setFill} compact />
            <input type="text"
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-2 w-full">
        <ColorPicker value={currentStroke || '#0BDA76'} onChange={v => onUpdate('stroke', v)} compact />
    ...
    <Section title="Gradient Overlay">
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <ColorPicker value={gradColor} onChange={c => onUpdateGradient(c, gradDir, gradStrength)} compact />
