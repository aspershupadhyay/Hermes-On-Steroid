    ...
    <div className="space-y-2.5">
      ...
      {sel && (
        <div className="flex items-center gap-1.5">
          <ColorPicker value={sel.color} onChange={c => setStop(clamped, { color: c })} compact />
      ...
      {mode === 'solid' && (
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <ColorPicker value={(typeof selFill === 'string' && inSelectionMode ? selFill : solidFill) || '#EAEAEA'} onChange={setSolid} compact />
            <input type="text"
