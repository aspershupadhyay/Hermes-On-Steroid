      ...
      {style.mode === 'solid' && (
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <ColorPicker value={style.color} onChange={c => up({ color: c })} compact />
      ...
      {style.mode === 'gradient' && (
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <ColorPicker value={style.fromColor} onChange={c => up({ fromColor: c })} compact />
          ...
          <div className="flex items-center gap-2">
            ...
            <ColorPicker value={style.toColor} onChange={c => up({ toColor: c })} compact />
