...
TEXT_MODELS: list[ModelDef] = [
    ...
    # ══ MiniMax ════════════════════════════════════════════════════════════
    # M2-her uses OpenAI-compatible /v1/text/chatcompletion_v2 endpoint
    _t("M2-her",             "M2 Her (Roleplay)",   "minimax", "recommended", False, 128000),
    # M2.7/M2.5 use Anthropic API-compatible endpoint
    _t("MiniMax-M2.7",       "MiniMax M2.7",       "minimax", "powerful",    False, 128000),
    _t("MiniMax-M2.7-highspeed", "MiniMax M2.7 HS", "minimax", "fast",      False, 128000),
    _t("MiniMax-M2.5",       "MiniMax M2.5",       "minimax", "recommended", False, 128000),
    _t("MiniMax-M2.5-highspeed", "MiniMax M2.5 HS", "minimax", "fast",      False, 128000),
